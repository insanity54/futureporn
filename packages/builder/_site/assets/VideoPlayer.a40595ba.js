import { _ as __vitePreload } from "./_slinkity_props_inputPath_.__website_vod-pages.76b7b9de.js";
import { S as SvelteComponent, i as init, s as safe_not_equal, c as create_slot, a as space, e as element, b as empty, d as claim_space, f as claim_element, g as children, h as detach, j as set_style, k as attr, l as insert_hydration, m as append_hydration, u as update_slot_base, n as get_all_dirty_from_scope, o as get_slot_changes, t as transition_in, p as transition_out, q as component_subscribe, r as onMount, v as defaultGateway, w as onDestroy, x as src_url_equal } from "./store.78950e7d.js";
...
const plyr_min = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Plyr
...
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      t = claim_space(nodes);
      video = claim_element(nodes, "VIDEO", { style: true, id: true, poster: true });
    ...
    h() {
      set_style(video, "--plyr-color-main", "#353fff");
      attr(video, "id", "player");
    ...
    p(ctx2, [dirty]) {
      ...
      if (!current || dirty & 48 && video_poster_value !== (video_poster_value = buildIpfsUrl(ctx2[5].pattern, ctx2[4]))) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let player;
  onMount(async () => {
    const { default: Plyr2 } = await __vitePreload(() => Promise.resolve().then(() => plyr_min), true ? void 0 : void 0);
    player = new Plyr2("#player", { "quality": { "default": 240 } });
