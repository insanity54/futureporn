import { S as SvelteComponent, i as init, s as safe_not_equal, c as create_slot, e as element, a as claim_element, b as children, d as detach, f as insert_hydration, u as update_slot_base, g as get_all_dirty_from_scope, h as get_slot_changes, t as transition_in, j as transition_out, k as createEventDispatcher, o as onMount, l as onDestroy, m as binding_callbacks, n as space, p as empty, q as claim_space, r as component_subscribe, v as defaultGateway, w as bind, x as create_component, y as claim_component, z as mount_component, A as add_flush_callback, B as destroy_component, C as attr, D as noop$1, E as src_url_equal, F as append_hydration } from "./store.6e58cc19.js";
import "./_slinkity_props_inputPath_.%2Fwebsite%2Fvod-pages.9b3d8a24.js";
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  function opts() {
    if (!options.hasOwnProperty("hideYouTubeDOMError")) {
      $$invalidate(1, options.hideYouTubeDOMError = true, options);
    }
    return options;
  }
  onMount(async () => {
    $$invalidate(2, player = new Plyr(plyrDiv.firstChild, opts));
  ...
  function div_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      plyrDiv = $$value;
      $$invalidate(0, plyrDiv);
    });
  }
  $$self.$$set = ($$props2) => {
    if ("eventsToEmit" in $$props2)
      $$invalidate(3, eventsToEmit = $$props2.eventsToEmit);
    if ("options" in $$props2)
      $$invalidate(1, options = $$props2.options);
    if ("player" in $$props2)
      $$invalidate(2, player = $$props2.player);
    if ("$$scope" in $$props2)
      $$invalidate(4, $$scope = $$props2.$$scope);
  };
  opts();
  return [plyrDiv, options, player, eventsToEmit, $$scope, slots, div_binding];
}
class Plyr_1 extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$1, safe_not_equal, { eventsToEmit: 3, options: 1, player: 2 });
  }
}
...
function create_else_block(ctx) {
  ...
  let updating_player;
  let current;
  function plyr_player_binding(value) {
    ctx[9](value);
  }
  let plyr_props = {
    eventsToEmit: ctx[7],
  ...
  if (ctx[6] !== void 0) {
    plyr_props.player = ctx[6];
  }
  plyr = new Plyr_1({ props: plyr_props });
  binding_callbacks.push(() => bind(plyr, "player", plyr_player_binding));
  plyr.$on("timeupdate", logEvent);
  return {
    c() {
      create_component(plyr.$$.fragment);
    },
    l(nodes) {
      claim_component(plyr.$$.fragment, nodes);
    },
    m(target, anchor) {
      mount_component(plyr, target, anchor);
      current = true;
    },
    p(ctx2, dirty) {
      const plyr_changes = {};
      if (dirty & 1087) {
        plyr_changes.$$scope = { dirty, ctx: ctx2 };
      }
      if (!updating_player && dirty & 64) {
        updating_player = true;
        plyr_changes.player = ctx2[6];
        add_flush_callback(() => updating_player = false);
      }
      plyr.$set(plyr_changes);
    },
    i(local) {
      if (current)
        return;
      transition_in(plyr.$$.fragment, local);
      current = true;
    },
    o(local) {
      transition_out(plyr.$$.fragment, local);
      current = false;
    },
    d(detaching) {
      destroy_component(plyr, detaching);
    }
  };
}
function create_if_block(ctx) {
  ...
  return {
    ...
    h() {
      attr(div, "class", "video-placeholder svelte-1m9s3uu");
    },
    m(target, anchor) {
      insert_hydration(target, div, anchor);
    },
...
function create_if_block_4(ctx) {
  ...
  return {
    ...
    l(nodes) {
      source2 = claim_element(nodes, "SOURCE", { src: true, type: true, size: true });
      this.h();
    },
    h() {
      if (!src_url_equal(source2.src, source_src_value = buildIpfsUrl(ctx[5].pattern, ctx[0])))
        attr(source2, "src", source_src_value);
      attr(source2, "type", "video/mp4");
      attr(source2, "size", "1080");
    },
    m(target, anchor) {
      insert_hydration(target, source2, anchor);
    },
    p(ctx2, dirty) {
      if (dirty & 33 && !src_url_equal(source2.src, source_src_value = buildIpfsUrl(ctx2[5].pattern, ctx2[0]))) {
        attr(source2, "src", source_src_value);
      }
    },
    d(detaching) {
...
function create_if_block_2(ctx) {
  ...
  return {
    ...
    h() {
      if (!src_url_equal(source2.src, source_src_value = buildIpfsUrl(ctx[5].pattern, ctx[2])))
        attr(source2, "src", source_src_value);
      attr(source2, "type", "video/mp4");
      attr(source2, "size", "360");
    },
    m(target, anchor) {
      insert_hydration(target, source2, anchor);
    },
    p(ctx2, dirty) {
      if (dirty & 36 && !src_url_equal(source2.src, source_src_value = buildIpfsUrl(ctx2[5].pattern, ctx2[2]))) {
        attr(source2, "src", source_src_value);
      }
    },
    d(detaching) {
...
function create_if_block_1(ctx) {
  ...
  return {
    ...
    h() {
      if (!src_url_equal(source2.src, source_src_value = buildIpfsUrl(ctx[5].pattern, ctx[3])))
        attr(source2, "src", source_src_value);
      attr(source2, "type", "video/mp4");
      attr(source2, "size", "240");
    },
    m(target, anchor) {
      insert_hydration(target, source2, anchor);
    },
    p(ctx2, dirty) {
      if (dirty & 40 && !src_url_equal(source2.src, source_src_value = buildIpfsUrl(ctx2[5].pattern, ctx2[3]))) {
        attr(source2, "src", source_src_value);
      }
    },
    d(detaching) {
...
function create_default_slot(ctx) {
  ...
  return {
    ...
    l(nodes) {
      video = claim_element(nodes, "VIDEO", { poster: true, src: true });
      var video_nodes = children(video);
      if (if_block0)
        if_block0.l(video_nodes);
      if_block0_anchor = empty();
      if (if_block1)
        if_block1.l(video_nodes);
      if_block1_anchor = empty();
      if (if_block2)
        if_block2.l(video_nodes);
      if_block2_anchor = empty();
      if (if_block3)
        if_block3.l(video_nodes);
      video_nodes.forEach(detach);
      this.h();
    },
    h() {
      attr(video, "poster", video_poster_value = buildIpfsUrl(ctx[5].pattern, ctx[4]));
      if (!src_url_equal(video.src, video_src_value = buildIpfsUrl(ctx[5].pattern, ctx[0])))
        attr(video, "src", video_src_value);
    },
    m(target, anchor) {
      insert_hydration(target, video, anchor);
      if (if_block0)
        if_block0.m(video, null);
      append_hydration(video, if_block0_anchor);
      if (if_block1)
        if_block1.m(video, null);
      append_hydration(video, if_block1_anchor);
      if (if_block2)
        if_block2.m(video, null);
      append_hydration(video, if_block2_anchor);
      if (if_block3)
        if_block3.m(video, null);
    },
    p(ctx2, dirty) {
      if (ctx2[0]) {
        if (if_block0) {
      ...
      if (dirty & 48 && video_poster_value !== (video_poster_value = buildIpfsUrl(ctx2[5].pattern, ctx2[4]))) {
        attr(video, "poster", video_poster_value);
      }
      if (dirty & 33 && !src_url_equal(video.src, video_src_value = buildIpfsUrl(ctx2[5].pattern, ctx2[0]))) {
        attr(video, "src", video_src_value);
      }
    },
    d(detaching) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  let video240Url;
  let $defaultGateway;
  component_subscribe($$self, defaultGateway, ($$value) => $$invalidate(5, $defaultGateway = $$value));
  let { $$slots: slots = {}, $$scope } = $$props;
  let { videoSrcHash = "" } = $$props;
  let { video720Hash = "" } = $$props;
  let { video360Hash = "" } = $$props;
  let { video240Hash = "" } = $$props;
  let { thiccHash = "" } = $$props;
  let player;
  ...
  $$self.$$set = ($$props2) => {
    if ("videoSrcHash" in $$props2)
      $$invalidate(0, videoSrcHash = $$props2.videoSrcHash);
    if ("video720Hash" in $$props2)
      $$invalidate(1, video720Hash = $$props2.video720Hash);
    if ("video360Hash" in $$props2)
      $$invalidate(2, video360Hash = $$props2.video360Hash);
    if ("video240Hash" in $$props2)
      $$invalidate(3, video240Hash = $$props2.video240Hash);
    if ("thiccHash" in $$props2)
      $$invalidate(4, thiccHash = $$props2.thiccHash);
    if ("$$scope" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    if ($$self.$$.dirty & 48) {
      buildIpfsUrl($defaultGateway.pattern, thiccHash);
    }
  };
  return [
    videoSrcHash,
